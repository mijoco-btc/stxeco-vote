	...
	<div class="mt-8">
		<div class="flex items-end justify-between">
			...
			<div class="flex items-center gap-2">
				<LinkToExplorer class="flex h-8 w-8 items-center justify-center rounded-md border border-transparent bg-black text-white transition duration-200 hover:border-gray-900" target={explorerAddressUrl(getAddress(true))} />
